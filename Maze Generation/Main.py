...
# To-do: implement mouse click, start and end points
...
def main():
    ...
    diagonals = raw_input("Would you like to give AStar the ability to move diagonally? Y/N (Default No) =>")
    ...
    while True:
        ...
        if len(fdims) != 2:
            ...
            try:
                ...
                if w * h > win_h * win_w:
                    print "Cell dimensions cannot be greater than screen dimensions of %fx%f" % (win_w, win_h)
                    continue
                return w, h
            except ValueError:
                print "Either width or height is not a number. No decimals or chars please"
